                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            // ✅ AU CLIC : OUVRE VOTRE NOUVEAU DIALOGUE
                            onTap: () {
                              showDialog(
                                context: context,
                                builder: (_) =>
...
// =============================================================================
// 2. VOTRE NOUVEAU DIALOGUE DE DÉTAILS
// =============================================================================
...
class _TransactionDetailsDialogState extends State<TransactionDetailsDialog> {
  ...
  // On définit la couleur ici pour respecter votre code
                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Options ajoutées (Adaptation robuste)
                            if (optionsGroups.isNotEmpty)
                              ...optionsGroups.map((opt) {
                                // Gestion des différents formats possibles de données
                                if (opt is Map) {
                                  // Cas complexe (Menu avec sous-items)
...
// =============================================================================
// 4. DIALOGUE GESTION DE STOCKS (Optimisé Tactile)
// =============================================================================
...
// =============================================================================
// 5. DIALOGUE INGRÉDIENTS INTERNE
// =============================================================================
