...
class FranchiseesView extends StatelessWidget {
  ...
  // ... (La méthode _deleteFranchisee reste inchangée)
              ...
              child: Padding(
                ...
                child: ListTile(
                  ...
                  trailing: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      // --- CORRECTION : Les Tooltip ont été retirés ---
                      IconButton(
                        icon: const Icon(Icons.edit_outlined),
                        // tooltip: "Modifier", // SUPPRIMÉ
                      ...
                      IconButton(
                        icon: const Icon(Icons.delete_forever_outlined,
                            color: Colors.red),
                        // tooltip: "Supprimer Définitivement", // SUPPRIMÉ
                        onPressed: () =>
...
// ... (Le reste du fichier, FranchiseeFormView et son State, reste inchangé)
